...
Invoke-Step "Zenodo/CITATION v0.6.0 metadata" {
  $matches = Select-String -LiteralPath @("README.md", "CITATION.cff", ".zenodo.json") -Pattern "v0\.6\.0|0\.6\.0"
  if (-not $matches) { throw "v0.6.0 DOI/release metadata missing" }
  $matches
}
