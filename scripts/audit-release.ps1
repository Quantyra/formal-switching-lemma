...
Invoke-Step "Zenodo/CITATION v0.10.0 metadata" {
  $matches = Select-String -LiteralPath @("README.md", "CITATION.cff", ".zenodo.json") -Pattern "v0\.10\.0|0\.10\.0"
  if (-not $matches) { throw "v0.10.0 DOI/release metadata missing" }
  $matches
}
