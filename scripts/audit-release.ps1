...
Invoke-Step "Zenodo/CITATION v0.7.0 metadata" {
  $matches = Select-String -LiteralPath @("README.md", "CITATION.cff", ".zenodo.json") -Pattern "v0\.7\.0|0\.7\.0"
  if (-not $matches) { throw "v0.7.0 DOI/release metadata missing" }
  $matches
}
